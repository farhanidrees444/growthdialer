    ...
    <MarketingShell>
      <JsonLd
        data={{
          ...
          '@type': 'WebPage',
          name: 'GrowthDialer Integrations',
          description: 'Connect HubSpot, Salesforce, Slack, Zapier, and your sales stack to GrowthDialer.',
          url: `${MARKETING_SITE}/features/integrations`,
        }}
      />

      <MarketingPageHero
        eyebrow="Integrations"
        title={<>Connect the stack you already run on.</>}
        description="HubSpot logs calls today. Salesforce, Slack, Zapier, and the rest are on the roadmap — join the waitlist from your workspace."
      >
        <a
          href={APP_SIGNUP}
      ...
      {categories.map((cat) => {
        ...
        return (
          <section key={cat} className="mx-auto mt-14 max-w-5xl px-5 lg:px-8">
