        ...
        {loading ? (
          ...
          <div className="space-y-2 lg:space-y-3 max-w-3xl">
            {recordings.map((r) => {
              ...
              return (
                <Card key={r.id} className="p-3 lg:p-4 flex items-center gap-3 lg:gap-4 border-white/10 bg-[oklch(0.086_0.024_282)]/90">
                  ...
                  <div className="flex items-center gap-1.5 lg:gap-2 shrink-0">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center justify-center h-8 w-8 rounded-md hover:bg-white/10 transition-colors text-muted-foreground hover:text-foreground"
