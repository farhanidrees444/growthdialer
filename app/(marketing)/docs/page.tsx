...
export default function DocsPage() {
  return (
    <div className="py-16 px-4 max-w-3xl mx-auto">
      <h1 className="font-display text-3xl font-bold mb-2 text-foreground">Documentation</h1>
      ...
      <section id="about" className="mb-12 scroll-mt-28">
        <h2 className="font-display text-xl font-semibold mb-3 text-foreground">About GrowthDialer</h2>
      ...
      <section id="api" className="mb-12 scroll-mt-28">
        <h2 className="font-display text-xl font-semibold mb-3 text-foreground">API</h2>
        <p className="text-muted-foreground text-sm mb-4">
          REST endpoints will live under <code className="text-primary">/api/v1</code>. For now, this app
      ...
      <section id="changelog" className="mb-12 scroll-mt-28">
        <h2 className="font-display text-xl font-semibold mb-3 text-foreground">Changelog</h2>
      ...
      <section id="roadmap" className="scroll-mt-28">
        <h2 className="font-display text-xl font-semibold mb-3 text-foreground">Roadmap</h2>
