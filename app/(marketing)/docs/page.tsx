...
export default function DocsPage() {
  return (
    <div className="py-16 px-4 max-w-3xl mx-auto">
      <h1 className="font-display text-3xl font-bold mb-2 text-[#F5F5F7]">Documentation</h1>
      ...
      <section id="about" className="mb-12 scroll-mt-28">
        <h2 className="font-display text-xl font-semibold mb-3 text-[#F5F5F7]">About GrowthDialer</h2>
      ...
      <section id="api" className="mb-12 scroll-mt-28">
        <h2 className="font-display text-xl font-semibold mb-3 text-[#F5F5F7]">API</h2>
        <p className="text-zinc-400 text-sm mb-4">
          REST endpoints will live under <code className="text-[#06B6D4]">/api/v1</code>. For now, this app
      ...
      <section id="changelog" className="mb-12 scroll-mt-28">
        <h2 className="font-display text-xl font-semibold mb-3 text-[#F5F5F7]">Changelog</h2>
        <ul className="text-sm text-zinc-400 space-y-2">
          <li>
            <span className="text-[#F5F5F7] font-medium">2026-04-08</span> — Auth, Stripe fallback, and
      ...
      <section id="roadmap" className="scroll-mt-28">
        <h2 className="font-display text-xl font-semibold mb-3 text-[#F5F5F7]">Roadmap</h2>
