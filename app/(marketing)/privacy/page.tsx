...
export default function PrivacyPage() {
  return (
    <div className="py-16 px-4 max-w-3xl mx-auto">
      <h1 className="font-display text-3xl font-bold mb-6 text-[#F5F5F7]">Privacy Policy</h1>
      ...
      <h2 className="font-display text-xl font-semibold mt-8 mb-2 text-[#F5F5F7]">Data we process</h2>
      <p className="text-zinc-400 text-sm leading-relaxed">
      ...
      <h2 className="font-display text-xl font-semibold mt-8 mb-2 text-[#F5F5F7]">Contact</h2>
      <p className="text-zinc-400 text-sm leading-relaxed">
        Questions: <a href="mailto:privacy@growthdialer.com" className="text-[#06B6D4] hover:underline">privacy@growthdialer.com</a>
      </p>
    </div>
  );
}
