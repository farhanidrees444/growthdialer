...
export function BlogHonestyBanner() {
  return (
    <div className="mb-10 rounded-xl border border-[#7C3AED]/20 bg-[#7C3AED]/[0.06] px-5 py-4 text-[14px] leading-relaxed text-zinc-600">
      <p className="font-medium text-[#6D28D9]">Honest editorial standard</p>
