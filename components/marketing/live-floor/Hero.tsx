    ...
    <section className="relative overflow-hidden px-5 pb-12 pt-32 lg:px-8 lg:pb-16 lg:pt-40">
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
        ...
        <div>
          ...
          >
            <span className="flex h-5 items-center gap-1.5 rounded-full bg-primary/10 px-2 text-[11px] font-medium text-primary">
            ...
            <span className="text-[13px] text-muted-foreground">AI Sales Dialer</span>
          </motion.div>
          ...
          <motion.h1
            ...
            className="font-display text-[clamp(2.6rem,6vw,4.75rem)] font-light leading-[0.98] tracking-tight text-foreground"
          >
            Every call,
            <br />
          ...
          >
            <a
              ...
              className="group inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-violet-600 px-6 text-sm font-medium text-white transition-all hover:bg-violet-700 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-600/60 focus-visible:ring-offset-2 focus-visible:ring-offset-background"
            >
              Start Free
            ...
            <a
              ...
              className="inline-flex h-12 items-center justify-center gap-2 rounded-xl border border-white/[0.08] px-6 text-sm font-medium text-muted-foreground/90 transition-all hover:border-white/[0.16] hover:text-foreground active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/20"
            >
              Log in
            </a>
          </motion.div>
          ...
          <BorderBeamCard>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-foreground">Outbound call</p>
                  <p className="text-xs text-muted-foreground/70">Connected · 02:14</p>
                </div>
              </div>
