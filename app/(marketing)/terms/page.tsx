    ...
    <MarketingShell>
      <article className="mx-auto max-w-3xl px-5 pb-24 pt-36 lg:px-8 lg:pt-44">
        ...
        <div className="mt-12 space-y-10 text-[15px] leading-relaxed text-zinc-600">
          <section>
            <h2 className="mb-3 font-display text-xl font-semibold text-zinc-950">Using GrowthDialer</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 font-display text-xl font-semibold text-zinc-950">Accounts</h2>
            <p>
              You are responsible for activity under your account and for keeping your credentials secure.
            </p>
          </section>
          <section>
            <h2 className="mb-3 font-display text-xl font-semibold text-zinc-950">Billing</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 font-display text-xl font-semibold text-zinc-950">Changes</h2>
            <p>
          ...
          <section>
            ...
            <p>
              Questions? Email{" "}
              <a href="mailto:legal@growthdialer.com" className="font-medium text-[#6D28D9] underline-offset-2 hover:underline">
