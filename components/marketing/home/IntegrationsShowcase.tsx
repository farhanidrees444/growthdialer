          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-white/[0.04] text-zinc-300 transition-colors group-hover:text-[#F5F5F7]">
                  <Icon className="h-4 w-4" />
                </span>
                <span className="text-[14px] font-medium text-[#F5F5F7]">{c.label}</span>
              </div>
              <span className="rounded-full border border-white/[0.08] px-2 py-0.5 text-[10px] text-zinc-500">Soon</span>
            </motion.div>
          );
        })}
      </motion.div>
